<template>
  <div :class="{ hidden: hidden }" class="pagination-special">
    <el-pagination
...
export default {
  ...
  mounted() {
    ...
    const total = document.querySelector(".pagination-special .el-pagination__total");
    ...
    const sizes = document.querySelector(".pagination-special .el-pagination__sizes");
